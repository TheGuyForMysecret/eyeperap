...
TARGET_MODULE_DIR = os.path.abspath(os.path.join(WORKSPACE_DIR, "Lycoris-RogueClone-Modules"))

# Timing sync paths
SOURCE_TIMING_DIR = os.path.abspath('./Timings')
TARGET_TIMING_DIR = os.path.abspath(os.path.join(WORKSPACE_DIR, "Lycoris-RogueClone-Timings"))

...
function LycorisTab.initCheatSettingsSection(groupbox)
	groupbox:AddButton("Toggle Silent Mode", function()
		...
		if isfile("smarker_ts.txt") then
			...
			writefile(
				"smarker_ts.txt",
				"Hello, if you're reading this, that means you have Lycoris-RogueClone silent mode turned on. Deleting this file will turn it off."
			)
		end
	end)
	...
	groupbox:AddButton("Toggle Player Scanning", function()
		...
		if isfile("dpscanning_ts.txt") then
			...
			writefile(
				"dpscanning_ts.txt",
				"Hello, if you're reading this, that means you have Lycoris-RogueClone player scanning turned off. Deleting this file will turn it on."
			)
		end
	end)

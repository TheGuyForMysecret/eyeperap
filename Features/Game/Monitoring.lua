return LPH_NO_VIRTUALIZE(function()
	...
	-- Signals.
	local renderStepped = Signal.new(runService.Heartbeat)
	...
	local function updateSpectating()
		...
		local leaderBoard = playerGui and playerGui:FindFirstChild("HUD")
		local list = leaderBoard and leaderBoard:FindFirstChild("Playerlist")
		local container = list and list:FindFirstChild("List"):FindFirstChild("Holder")
	...
	function Monitoring.init()
		-- Attach.
		monitoringMaid:add(renderStepped:connect("Monitoring_OnHeartbeat", updateMonitoring))
